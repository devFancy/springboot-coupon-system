...
export function setup() {
    ...
    const loginRes = http.post('http://{API_서버_IP}:{API_서버_PORT}/api/auth/login', loginPayload, {
...
export default function (data) {
    ...
    const createRes = http.post('http://{API_서버_IP}:{API_서버_PORT}/api/coupon', createPayload, {
